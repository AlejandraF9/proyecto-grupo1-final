...
init() {
  ...
  const salesConditionsTextText = document.createElement("p");
  salesConditionsTextText.innerHTML = `AQUÍ IRÍAN LAS CONDICIONES GENERALES DE VENTA <br> 
  ...
  salesConditionsTextDiv.appendChild(salesConditionsTextText);
}
}
