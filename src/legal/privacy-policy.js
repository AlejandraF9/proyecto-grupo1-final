export function init() {
  ...
  const privacyTextText = document.createElement("p");
  privacyTextText.innerHTML = `AQUÍ IRÍA LA POLÍTICA DE PRIVACIDAD <br> 
  ...
  privacyTextDiv.appendChild(privacyTextText);
}