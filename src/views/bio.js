...
export function renderBio() {
  ...
  function createSectionQueTenemos() {
    ...
    const text = createTextDiv("bio-text-004", [
      "Trabajamos con productos llenos de sabor y calidad.",
      "",
      "Contamos con especialidades por temporada,",
  ...
  function createBioView() {
    ...
    bioImg.src =
      "https://img.freepik.com/foto-gratis/primer-plano-sonriente-mujer-joven-tenencia-tazon-mezcla-panaderia_23-2148189077.jpg";
